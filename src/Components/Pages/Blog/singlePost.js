        ...
        <>
            <main className="main-container">
                ...
                <section className="section-post">
                    ...
                    <div id='content'className="blog-content"><BlockContent  serializers={serializers} imageOptions={{  w: 660, h: 435, fit: "min" }} blocks={singlePost.body} projectId="c3bnpuzz" dataset="production"/></div>
